...
import com.tony.coolweather.gson.Forecast;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    private TextView titleUpdateTitle;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        titleUpdateTitle = (TextView) findViewById(R.id.title_update_time);
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        titleUpdateTitle.setText(updateTime);
